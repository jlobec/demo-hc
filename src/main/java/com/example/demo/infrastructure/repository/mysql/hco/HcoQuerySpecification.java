...
public class HcoQuerySpecification {

    public static Specification<HealthcareOrganizationEntity> withCriteria(
            Integer id, String name, HealthcareOrganizationEntityStatus status) {
